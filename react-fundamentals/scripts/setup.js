...
if (error) {
  console.error(color('danger', '🚨  npx is not available on this computer. Please install npm@5.2.0 or greater'))
  throw error
}

var command = 'npx "https://gist.github.com/kentcdodds/bb452ffe53a5caa3600197e1d8005733" -q'
